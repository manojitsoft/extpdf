    ...
    protected int goComposite(boolean simulate) throws DocumentException {
        ...
        while (true) {
            ...
            if (element.type() == Element.PARAGRAPH) {
                ...
                com.extpdf.pdfutil.List list = (com.extpdf.pdfutil.List)element;
                ...
                for (int k = 0; k < items.size(); ++k) {
                    ...
                    else if (obj instanceof com.extpdf.pdfutil.List) {
                        stack.push(new Object[]{list, new Integer(k), new Float(listIndentation)});
                        list = (com.extpdf.pdfutil.List)obj;
                        items = list.getItems();
                    ...
                    if (k == items.size() - 1) {
                        if (!stack.isEmpty()) {
                            ...
                            list = (com.extpdf.pdfutil.List)objs[0];
                            items = list.getItems();
