 ...
 * peteremidford@yahoo.com.  Mesquite itself is copyright 1997-2005 by W. and D.
...
import com.extpdf.pdfutil.PageSize;
...
//    }
    ...
    private void readDecryptedDocObj() throws IOException {
        ...
        if (documentIDs != null) {
            ...
            s = o.toString();
            documentID = com.extpdf.pdfutil.DocWriter.getISOBytes(s);
        }
        
        s = enc.get(PdfName.U).toString();
        byte uValue[] = com.extpdf.pdfutil.DocWriter.getISOBytes(s);
        s = enc.get(PdfName.O).toString();
        byte oValue[] = com.extpdf.pdfutil.DocWriter.getISOBytes(s);
