 ...
 * <P>
 * When using variable borders ({@link com.extpdf.pdfutil.Rectangle#isUseVariableBorders isUseVariableBorders()} == true),
 ...
 * cells.
 *
 * @see		com.extpdf.pdfutil.Rectangle
 * @see		com.extpdf.pdfutil.Cell
 * @see		PdfLine
 * @see		PdfTable
 */
...
public class PdfCell extends Rectangle {
     ...
     * @param side the side to check.  One of the side constants in {@link com.extpdf.pdfutil.Rectangle}
     */
