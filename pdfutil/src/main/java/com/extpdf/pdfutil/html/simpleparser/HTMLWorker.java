...
import com.extpdf.pdfutil.*;
import com.extpdf.pdfutil.pdf.*;
...
public class HTMLWorker implements SimpleXMLDocHandler, DocListener {
    ...
    public void startElement(String tag, HashMap h) {
        ...
        if (tag.equals("ul")) {
            ...
            skipText = true;
            cprops.addToChain(tag, h);
            com.extpdf.pdfutil.List list = new com.extpdf.pdfutil.List(false, 10);
            list.setListSymbol("\u2022");
            stack.push(list);
            return;
        }
        if (tag.equals("ol")) {
            ...
            skipText = true;
            cprops.addToChain(tag, h);
            com.extpdf.pdfutil.List list = new com.extpdf.pdfutil.List(true, 10);
            stack.push(list);
            return;
        }
        if (tag.equals("li")) {
            ...
            pendingLI = true;
            cprops.addToChain(tag, h);
            stack.push(new com.extpdf.pdfutil.ListItem());
            return;
        }
        ...
        try {
            ...
            if (tag.equals("ul") || tag.equals("ol")) {
                ...
                if (stack.empty())
                    return;
                Object obj = stack.pop();
                if (!(obj instanceof com.extpdf.pdfutil.List)) {
                    stack.push(obj);
                    return;
                }
                if (stack.empty())
            ...
            if (tag.equals("li")) {
                ...
                if (!(list instanceof com.extpdf.pdfutil.List)) {
                    stack.push(list);
                    return;
                }
                ListItem item = (ListItem)obj;
                ((com.extpdf.pdfutil.List)list).add(item);
