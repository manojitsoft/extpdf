...
import com.extpdf.pdfutil.pdf.PdfPCell;
import com.extpdf.pdfutil.pdf.PdfPTable;
import com.extpdf.pdfutil.pdf.PdfPTableEvent;
/**
 ...
 */
	...
	public class BorderEvent implements PdfPTableEvent {
    	...
    	/**
	     * @see com.extpdf.pdfutil.pdf.PdfPTableEvent#tableLayout(com.extpdf.pdfutil.pdf.PdfPTable, float[][], float[], int, int, com.extpdf.pdfutil.pdf.PdfContentByte[])
	 	 */
