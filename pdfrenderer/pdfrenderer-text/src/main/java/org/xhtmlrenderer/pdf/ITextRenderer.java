...
public class ITextRenderer {
    ...
    private com.extpdf.pdfutil.Document _pdfDoc;
    ...
    public void writeNextDocument(int initialPageNo) throws DocumentException {
        ...
        com.extpdf.pdfutil.Rectangle firstPageSize = new com.extpdf.pdfutil.Rectangle(0, 0, firstPage.getWidth(c) / _dotsPerPoint,
    ...
    public void createPDF(OutputStream os, boolean finish, int initialPageNo) throws DocumentException {
        ...
        com.extpdf.pdfutil.Document doc = new com.extpdf.pdfutil.Document(firstPageSize, 0, 0, 0, 0);
        ...
        if (_pdfEncryption != null) {
            writer.setEncryption(_pdfEncryption.getUserPassword(), _pdfEncryption.getOwnerPassword(),
                    _pdfEncryption.getAllowedPrivileges(), _pdfEncryption.getEncryptionType() == com.itextpdf.text.pdf.PdfWriter.STANDARD_ENCRYPTION_128);
        }
        _pdfDoc = doc;
        _writer = writer;
    ...
    private void writePDF(List pages, RenderingContext c, com.extpdf.pdfutil.Rectangle firstPageSize, com.extpdf.pdfutil.Document doc,
        ...
        for (int i = 0; i < pageCount; i++) {
            ...
            if (i != pageCount - 1) {
                ...
                com.extpdf.pdfutil.Rectangle nextPageSize = new com.extpdf.pdfutil.Rectangle(0, 0, nextPage.getWidth(c) / _dotsPerPoint,
    ...
    private void setDidValues(com.extpdf.pdfutil.Document doc) {
